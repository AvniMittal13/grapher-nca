...
## Grapher-NCA Models
**GrapherNCA_M1:** Pixel-Grapher-NCA — Grapher replaces Sobel perception \n
**GrapherNCA_M2:** Patch-Grapher-NCA — Grapher concatenated with conv perception \n

## Additional Datasets
**ISIC2018_Dataset:** ISIC 2018 skin lesion segmentation (2D JPEG/PNG) \n
"""